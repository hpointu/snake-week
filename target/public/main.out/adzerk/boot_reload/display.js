...
var attr = cljs.core.nth.call(null,vec__12515,(0),null);
...
var len__8410__auto___12522 = arguments.length;
var i__8411__auto___12523 = (0);
while(true){
if((i__8411__auto___12523 < len__8410__auto___12522)){
args__8417__auto__.push((arguments[i__8411__auto___12523]));

var G__12524 = (i__8411__auto___12523 + (1));
i__8411__auto___12523 = G__12524;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__8418__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq12521){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12521));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__12525){
var map__12526 = p__12525;
var map__12526__$1 = ((((!((map__12526 == null)))?((((map__12526.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12526.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12526):map__12526);
var data = map__12526__$1;
var message = cljs.core.get.call(null,map__12526__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__12526__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__12526__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__12528 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__12528,goog.events.EventType.CLICK,((function (G__12528,map__12526,map__12526__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__12528,map__12526,map__12526__$1,data,message,line,file))
);

return G__12528;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__12529){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__12533){
...
var messages = map__12534__$1;
var warnings = cljs.core.get.call(null,map__12534__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__12534__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__12536 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__12536,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__12536,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__12537){
...
var messages = map__12538__$1;
var warnings = cljs.core.get.call(null,map__12538__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__12538__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__12538,map__12538__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__12538,map__12538__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__12538,map__12538__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__12538,map__12538__$1,messages,warnings,exception))
;
...
}catch (e12540){if((e12540 instanceof Error)){
var __12541 = e12540;
} else {
throw e12540;
